...
{
	public static void AddDefaultDepartments(Project project, List<Department> deps)
	{
		var defaultDepartments = deps.Where(dep => dep.IncludeInWorkPlan).ToList();
	...
	public static Dictionary<Guid, HashSet<UserPosition>> GetExistingDepartmentPositions(List<Department> deps)
	{
